...
class DrawerListController(private val listener: OnDrawerClickListener, val address: String, val name: String, val screenPath: String = "", val iconPath: String = "") : TypedEpoxyController<List<DrawerEntity>>() {
    @AutoModel
